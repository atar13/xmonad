...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- take a screenshot and save it to ~/Pictures/scrot
    , ((modm .|. shiftMask, xK_s     ), spawn "scrot ~/Pictures/scrot/`$DATE`.png")
...
--
main = do 
  xmproc0 <- spawnPipe "xmobar -x 0 /home/atarbinian/.config/xmobar/xmobarrc"
  -- xmproc <- panel 
